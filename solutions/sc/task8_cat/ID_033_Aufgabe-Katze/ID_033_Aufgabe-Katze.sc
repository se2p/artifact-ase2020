program strid "ID_033_Aufgabe-Katze"
...
actor Stage is ScratchStage begin 
    ...
    image strid "blue sky" "134bf245765a320505b3aa6978fa7dc7.svg"
    sound Plopp "83a9787d4cb6f3b7632b4ddfebf74367.wav"


    script on bootstrap do begin 
        changeActiveGraphicTo("blue sky")
    end 
...
actor Katze is ScratchSprite begin 
    ...
    script on startup do begin 
        moveSteps(10)
        pointInDirection( 90)
        pointTowards(locate actor "Ball")
    end 
